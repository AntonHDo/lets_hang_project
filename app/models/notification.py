...
#     other_user = db.relationship("User", foreign_keys=[other_user_id], cascade="all, delete")
#     scheduling = db.relationship("Scheduling", foreign_keys=[scheduling_id], cascade="all, delete")
